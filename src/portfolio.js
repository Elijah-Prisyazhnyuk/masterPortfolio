...
const degrees = {
  ...
  degrees: [
    ...
    },
    {
      ...
      document_link: "https://drive.google.com/file/d/1EBFBN-gmvYqDiHH0xIWHz3SRRJoNFuSr/view?usp=sharing",
...
const hobbies = {
  ...
  subTitle_ru: "Самая хорошая работа — это высокооплачиваемое хобби.",
  subTitle_de: "Ich verbringe meine Freizeit mit meinen Hobbys!",
  hobbies: [
    {
      title_en: "Music",
      title_ru: "Музыка",
